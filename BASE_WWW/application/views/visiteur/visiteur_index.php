<?php //Page principale de l'application web ?>
			...
			<div class="container">
				...
				<div class="card">  
				  ...
				  <div class="card-body">
				    <p>
						Si vous le souhaitez, vous pouvez utiliser le service MaPhoto.Link afin de publier vos photo en haute qualité tout en conservant les droits sur celles-ci (les services en ligne tel que FaceBook et Google vous démuni de vos droits - <a href="">Plus d'informations </a>) Pour tout renseignement ou adhésion, rendez-vous dans l'espace Photographe (lien ci-dessous).	    	
				    </p>
				  </div>				  
				</div><br>			
				<div class="row text-center">
					<div class="col-6">
						<p class="lead text-muted">Vous êtes nouveau ? Adhèrez à l'espace membre pour pouvoir bénéficier de notre application.</p>
						<button type="button" class="btn btn-dark btn-lg">S'inscrire</button><br>
					</div>
					<div class="col-6">
						<p class="lead text-muted">Vous êtes déja membre ? Connecter vous en cliquant sur le lien ci-dessous.</p>
